...
class EnhancedFaceRecognitionSystem:
    ...
    def __init__(self, database):
        ...
        # Padding for saved face images (0.4 = 40% padding)
        self.save_padding = 0.4  # Adjust this value to zoom in/out
    ...
    def recognize_faces(self, frame):
        ...
        for (top, right, bottom, left), face_encoding in zip(face_locations, face_encodings):
            ...
            # Save face if outsider or college non-mess (passing roll_no)
            if category in ['outsider', 'college']:
                self.save_detected_face(frame, (left, top, right, bottom), category, roll_no)
    ...
    def save_detected_face(self, frame, box, category, roll_no="UNKNOWN"):
        ...
        pad_x = int(face_width * self.save_padding)
        pad_y = int(face_height * self.save_padding)
    ...
    def start_recognition(self):
        ...
        print(f"✓ Face save padding: {int(self.save_padding * 100)}%")
        print("\nColor Legend:")
...
def main():
    ...
    students_to_enroll = [
        ...
        # Example 2: College student (no mess)
        {
            ...
            'name': 'Rahul Sharma',
            'department': 'IT',
            'image_path': 'enrollment_photos/2022bit051.jpg',
